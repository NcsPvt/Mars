...
public interface GooglePlacesInterface extends Types, Statuses {
     ...
     * {@link itc.google.places.exception.GooglePlacesException} will be thrown.
     *
     * @param lat    latitude
     * @param lng    longitude
     * @param limit  the maximum amount of places to return
     ...
     * @throws itc.google.places.exception.GooglePlacesException if 'keyword', 'name' or 'types' is not included.
     */
